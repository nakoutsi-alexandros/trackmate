    ...
    <>
      ...
      <style jsx global>{`
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ─── DESKTOP MAIN ─── */
        .desktop-main { flex: 1; display: flex; flex-direction: column; overflow: hidden; background: #e3e4df; }
        .desktop-header { padding: 14px 24px 12px; background: #eeeeea; border-bottom: 1px solid #d6d7d0; display: flex; align-items: center; justify-content: space-between; gap: 12px; }
        ...
        /* ─── MOBILE HEADER ─── */
        .mob-header { background: #eeeeea; border-bottom: 1px solid #d6d7d0; position: sticky; top: 0; z-index: 10; }
        ...
        .mob-main { flex: 1; padding: 14px 16px; background: #e3e4df; }

        /* ─── SHARED COMPONENTS ─── */
        .card { background: #f2f2ef; border: 1px solid #d6d7d0; border-radius: 12px; padding: 16px; margin-bottom: 10px; }
        .card-title { font-size: 14px; font-weight: 600; margin-bottom: 3px; }
        .card-sub { font-size: 12px; color: #6b7280; margin-bottom: 14px; }
        .upload-area { border: 1.5px dashed #b9bab2; border-radius: 10px; padding: 32px 20px; text-align: center; cursor: pointer; transition: all 0.12s; background: #e9eae5; }
        .upload-area:hover { border-color: #8f9188; background: #dedfd8; }
